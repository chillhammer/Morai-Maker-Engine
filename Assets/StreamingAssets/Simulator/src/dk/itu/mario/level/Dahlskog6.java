...
//THIS IS THE ONE
public class Dahlskog6 extends Level{
...
private int type;
private int gaps;
public Dahlskog6(int width, int height)
{
super(width, height);
}
public Dahlskog6(int width, int height, long seed, int difficulty, int type, GamePlay playerMetrics)
{
this(width, height);
...
setSpriteTemplate(10, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(39, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(85, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(121, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(150, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
