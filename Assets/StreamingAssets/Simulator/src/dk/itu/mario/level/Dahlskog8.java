...
//THIS IS THE ONE
public class Dahlskog8 extends Level{
...
private int type;
private int gaps;
public Dahlskog8(int width, int height)
{
super(width, height);
}
public Dahlskog8(int width, int height, long seed, int difficulty, int type, GamePlay playerMetrics)
{
this(width, height);
...
setSpriteTemplate(92, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(97, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(106, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(186, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
