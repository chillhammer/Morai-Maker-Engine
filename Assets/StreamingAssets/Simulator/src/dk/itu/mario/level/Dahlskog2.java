...
//THIS IS THE ONE
public class Dahlskog2 extends Level{
...
private int type;
private int gaps;
public Dahlskog2(int width, int height)
{
super(width, height);
}
public Dahlskog2(int width, int height, long seed, int difficulty, int type, GamePlay playerMetrics)
{
this(width, height);
...
setSpriteTemplate(1, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(50, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(62, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(148, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
...
setSpriteTemplate(162, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
