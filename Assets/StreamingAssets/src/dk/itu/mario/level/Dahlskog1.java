...
//THIS IS THE ONE
public class Dahlskog1 extends Level{
...
private int type;
private int gaps;
public Dahlskog1(int width, int height)
{
super(width, height);
}
public Dahlskog1(int width, int height, long seed, int difficulty, int type, GamePlay playerMetrics)
{
this(width, height);
...
setSpriteTemplate(71, 10, new SpriteTemplate(Enemy.ENEMY_GREEN_KOOPA, false));
